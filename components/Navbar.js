...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <nav className=" relative top-0 z-50 hidden h-20 w-full items-center justify-between  px-12 text-white md:flex">
        ...
        <ul className="flex w-full grow items-center justify-end gap-4 text-xl">
          <li>
            <Link
              className=" p-2 text-lg font-medium sm:text-xl xl:text-2xl "
              href="/#services"
            >
              Servicios
            </Link>
          ...
          <li>
            <Link
              className="hidden p-2 text-lg font-medium sm:inline-flex sm:text-xl xl:text-2xl "
              href="/#blogs"
            >
              Blogs
            </Link>
