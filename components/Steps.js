...
const Steps = () => {
  return (
    <section className='relative flex w-full items-center  justify-between py-12 px-10'>
      <GearColumn />
      <div className='flex w-full flex-col items-center gap-4 md:w-4/5'>
        <h3 className='border-b-2 border-orange-300 w-fit text-xl text-orange-500 lg:text-2xl'>
